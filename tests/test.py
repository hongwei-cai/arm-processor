...
p2sc_tests = [
  ...
  ("MOV AND register test",
    TestCase(os.path.join(file_locations,'mov-and-reg.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0xe3a00008],
         [8, 0, 0, 0x0, 0x0, 1, 0x4, 0xe3a01007],
         [8, 7, 0, 0x0, 0x0, 2, 0x8, 0xe0000001],
         [0, 7, 0, 0x0, 0x0, 3, 0xC, 0xe3a02003],
         [0, 7, 3, 0x0, 0x0, 4, 0x10, 0xe0011002],
         [0, 3, 3, 0x0, 0x0, 5, 0x14, 0x0]]), "cpu"),
  ("MOV AND imm test",
  ...
  ("MOV ORR register test",
    TestCase(os.path.join(file_locations,'mov-orr-reg.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0xe3a00008],
         [8, 0, 0, 0x0, 0x0, 1, 0x4, 0xe3a01007],
         [8, 7, 0, 0x0, 0x0, 2, 0x8, 0xe1800001],
         [15, 7, 0, 0x0, 0x0, 3, 0xC, 0xe3a02006],
         [15, 7, 6, 0x0, 0x0, 4, 0x10, 0xe1802002],
         [15, 7, 15, 0x0, 0x0, 5, 0x14, 0x0]]), "cpu"),
  ("MOV ORR imm test",
 ...
 ("MOV EOR register test",
    TestCase(os.path.join(file_locations,'mov-eor-reg.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0xe3a00007],
         [7, 0, 0, 0x0, 0x0, 1, 0x4, 0xe3a0100f],
         [7, 15, 0, 0x0, 0x0, 2, 0x8, 0xe0202001],
         [7, 15, 8, 0x0, 0x0, 3, 0xC, 0x0]]), "cpu"),
  ("MOV EOR imm test",
  ...
  ("Data-processing ROT test",
    TestCase(os.path.join(file_locations,'mov-rot.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0xe3a00f4b],
         [300, 0, 0, 0x0, 0x0, 1, 0x4, 0xe2801e19],
         [300, 700, 0, 0x0, 0x0, 2, 0x8, 0x0]]), "cpu"),
         ]
