...
p2sc_tests = [
  ...
  ("MOV SUB register test",
    TestCase(os.path.join(file_locations,'mov-sub-reg.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0,  0xe3a00001],
         ...
         [1, 2, 0xffffffff, 0x0, 0x0, 3, 0xC,  0x00000000]]), "cpu"),
  ("MOV LSL test",
    TestCase(os.path.join(file_locations,'mov-lsl.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0,  0xe3a00001],
         [1, 0, 0, 0x0, 0x0, 1, 0x4,  0xe1a01180],
         [0, 2, 0, 0x0, 0x0, 2, 0x8, 0xe3a00004],
         [4, 2, 0, 0x0, 0x0, 3, 0xC, 0xe1a02380],
         [4, 2, 64, 0x0, 0x0, 4, 0x10, 0x00000000]]), "cpu"),
  ("MOV LSR test",
    TestCase(os.path.join(file_locations,'mov-lsr.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0,  0xe3a00001],
         [1, 0, 0, 0x0, 0x0, 1, 0x4,  0xe1a01020],
         [1, 0, 0, 0x0, 0x0, 2, 0x8, 0xe3e00003],
         [0xfffffffe, 0, 0, 0x0, 0x0, 3, 0xC, 0xe1a020a0],
         [0xfffffffe, 0, 3, 0x0, 0x0, 4, 0x10, 0x00000000]]), "cpu"),
  ("MOV ORR imm test",
    TestCase(os.path.join(file_locations,'mov-orr-i.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0,  0xe3a000ef],
         ...
         [6, 255, 15, 0x0, 0x0, 4, 0x10, 0x00000000]]), "cpu"),
  ("MOV EOR imm test",
    TestCase(os.path.join(file_locations,'mov-eor-i.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0,  0xe3a00000],
         ...
         [5, 1, 6, 0x0, 0x0, 4, 0x10, 0x00000000]]), "cpu"),
  ...
  ("B backward test",
    TestCase(os.path.join(file_locations,'branch-backward.circ'),
        [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0xe3a00000],
         [0, 0, 0, 0x0, 0x0, 1, 0x4, 0xe3500003],
         [0, 0, 0, 0x0, 0x0, 2, 0x8, 0xaa000001],
         [0, 0, 0, 0x0, 0x0, 3, 0xc, 0xe2800001],
         [1, 0, 0, 0x0, 0x0, 4, 0x10, 0xeafffffb],
         [1, 0, 0, 0x0, 0x0, 5, , 0xaa000001]         
